...
class FormMaker_Validate_EmailAddress extends FormMaker_Validate_Abstract
{
    ...
    const LENGTH_EXCEEDED    = 'emailAddressLenghtExceeded';
     ...
     * 'hostname' => A hostname validator, see Validate_Hostname
     * 'allow'    => Options for the hostname validator, see Validate_Hostname::ALLOW_*
     ...
     *
     * @param array $options
     * @return Validate_EmailAddress fluid interface
     */
    ...
    /**
     * @param Validate_Hostname $hostnameValidator OPTIONAL
