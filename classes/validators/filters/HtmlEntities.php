 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Filter_HtmlEntities implements Filter_Interface
{
    /**
     ...
     * @return Filter_HtmlEntities Provides a fluent interface
     */
    ...
    public function filter($value)
    {
        ...
        if (strlen((string) $value) && !strlen($filtered)) {
            if (!function_exists('iconv')) {
                throw new Filter_Exception('Encoding mismatch has resulted in htmlentities errors');
            }
