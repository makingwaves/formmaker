jQuery(document).ready( function() {
    ...
    jQuery( document.body ).on( 'click', '.formField .remove-field', function(){
    ...
    jQuery( document.body ).on( 'click', '.attribute-mandatory-holder input[type=checkbox]', function(){
        var value = 0;
        if ($(this).is(':checked')) {
            value = 'on';
        }
    ...
    jQuery( document.body ).on( 'click', '.email-receiver-inputs input[type=checkbox]', function(){
        var value = 0;
        if ($(this).is(':checked')) {
            value = 1;
        }
    ...
    jQuery( document.body ).on( 'click', '.formField .add-option', function(){
        jQuery('.form-ajax-loader').show();
    ...
    jQuery( document.body ).on( 'click', '.form-attribute-options .option-remove', function(){
    ...
    jQuery( document.body ).on( 'click', '.form-attribute-options .option-move-up', function(){
    ...
    jQuery( document.body ).on( 'click', '.form-attribute-options .option-move-down', function(){
    ...
    jQuery( document.body ).on( 'click', '.default-radio input[type=checkbox]', function(){
        var hidden_value = '';
    ...
    // "enable" checkbox
    jQuery( document.body ).on( 'click', '.enable-attribute input[type=checkbox]', function(){
        var value = 0;
    ...
    jQuery( document.body ).on( 'blur', '.custom-regex-inputs > input[type=text]', function(){
        $(this).parents('.form-field-attributes-container')
    ...
    jQuery( document.body ).on( 'click', '.attribute-validation', function(){
