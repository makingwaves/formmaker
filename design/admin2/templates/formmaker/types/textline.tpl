...
<div class="formField form-{$input.id}">
    ...
    <div class="form-field-attributes-container">
        ...
        {include uri="design:formmaker/types/elements/default_text.tpl" default_value=$data.default_value input_id=$input_id}
        {include uri="design:formmaker/types/elements/css.tpl" css=$data.css input_id=$input_id}
        {include uri="design:formmaker/types/elements/validation.tpl" email_receiver=$data.email_receiver validators=$input.validators validator_ids=$data.validator_ids 
