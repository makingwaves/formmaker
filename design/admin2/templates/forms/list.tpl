{def $remove_access = fetch( 'user', 'has_access_to', hash( 'module', 'mwezforms', 'function', 'remove' ) )}
...
<div class="context-block tags-dashboard">
    <div class="box-header">
        <h1 class="context-title">{'List forms'|i18n( 'extension/mwezforms/admin' )}</h1>
                ...
                <div id="content-sub-items-list" class="content-navigation-childlist yui-dt">
                    <table>
                        <thead>
                            <tr class="yui-dt-first yui-dt-last">
                                <th id="yui-dt0-th-name" class="yui-dt0-col-name yui-dt-col-name yui-dt-resizeable" style="width: 20px">
                                    <div class="yui-dt-resizerliner">
                                        <div id="yui-dt0-th-name-liner" class="yui-dt-liner">
                                            <span class="yui-dt-label">{'ID'|i18n( 'extension/mwezforms/admin' )}</span>
                                        </div>
                                ...
                                <th id="yui-dt0-th-name" class="mwezform-list-name yui-dt0-col-name yui-dt-col-name yui-dt-resizeable">
                                    <div class="yui-dt-resizerliner">
                                        <div id="yui-dt0-th-name-liner" class="yui-dt-liner">
                                            <span class="yui-dt-label">{'Name'|i18n( 'extension/mwezforms/admin' )}</span>
                                        </div>
                                        <div id="yui-dt0-th-name-resizer" class="yui-dt-resizer" style="left: auto; right: 0px; top: auto; bottom: 0px; height: 23px;"></div>
                                    </div>
                                </th>
                                ...
                                <th id="yui-dt0-th-name" class="yui-dt0-col-name yui-dt-col-name yui-dt-resizeable">
                                    <div class="yui-dt-resizerliner">
                                        <div id="yui-dt0-th-name-liner" class="yui-dt-liner">
                                            <span class="yui-dt-label">{'Created'|i18n( 'extension/mwezforms/admin' )}</span>
                                        </div>
                                        <div id="yui-dt0-th-name-resizer" class="yui-dt-resizer" style="left: auto; right: 0px; top: auto; bottom: 0px; height: 23px;"></div>
                                    </div>
                                </th>                                
                                ...
                                <th id="yui-dt0-th-name" class="yui-dt0-col-name yui-dt-col-name yui-dt-resizeable" style="width: 160px; text-align: center;">
                                    <div class="yui-dt-resizerliner">
                                        <div id="yui-dt0-th-name-liner" class="yui-dt-liner">
                                            <span class="yui-dt-label">{'Actions'|i18n( 'extension/mwezforms/admin' )}</span>
                                        </div>
                                        <div id="yui-dt0-th-name-resizer" class="yui-dt-resizer" style="left: auto; right: 0px; top: auto; bottom: 0px; height: 23px;"></div>
                                    </div>
                                </th>
                        ...
                        <tbody class="yui-dt-message">
                                ...
                                <tr class="yui-dt-first yui-dt-last">
                                    ...
                                    <td class="yui-dt-empty" style="text-align: center;">
                                        <div class="yui-dt-liner">
                                            <a class="mwezforms_edit_form" href={concat('mwezforms/edit/', $form.id)|ezurl()}>Edit</a>
                                                {if $remove_access}
                                                |
                                                <a class="mwezforms_remove_form" href={concat('mwezforms/remove/', $form.id)|ezurl()}>Remove</a>
                                            {/if}
                                        </div>
                                    </td>
                                </tr>
                            ...
                            {if not( $forms|count() )}
                                <tr><td class="mwezforms_no_forms" colspan="3">{'There are no forms for now. Add some!'|i18n( 'extension/mwezforms/admin' )}</td></tr>
                            {/if}
                        </tbody>
                    </table>      
                </div>
                    ...
                    <div class="box-bc">
                        <div class="box-ml">
                            <div class="button-right">
                                <form name="tagadd" id="tagadd" style="float:left;" enctype="multipart/form-data" method="post" action={'mwezforms/edit'|ezurl}>
                                    <input class="defaultbutton" type="submit" name="SubmitButton" value="{"Create new form"|i18n( "extension/mwezforms/admin" )}" />
                                </form>
                            </div>
