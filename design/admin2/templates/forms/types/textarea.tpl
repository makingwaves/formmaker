...
<div class="formFieldTemplate" id="tpl_textarea" rel="new">
    ...
    {'css class'|i18n( 'extension/mwezforms/admin' )}: <input disabled="disabled" name="css_classes[]" type="text"></input> <span class="spc clear"></span>
...
<div class="formField" rel="0">
    ...
    {'css class'|i18n( 'extension/mwezforms/admin' )}: <input name="css_classes[]" type="text" value="{$item.css_class}"></input> <span class="spc clear"></span>
