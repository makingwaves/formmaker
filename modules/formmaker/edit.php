...
$form_elements = array( 'name'          => array(   'required'  => true, 
                        ...
                        'summary_label' => array(   'required'  => false, 
                                                    'type'      => 'text',
                                                    'value'     => '' ),    
                        'receipt_page'  => array(   'required'  => false, 
                                                    'label'     => ezpI18n::tr('extension/formmaker/admin', 'I want a receipt page with the following label' ), 
                                                    'type'      => 'checkbox',
                                                    'value'     => '' ),
                        'receipt_label' => array(   'required'  => false, 
                                                    'type'      => 'text',
                                                    'value'     => '' )     
);
